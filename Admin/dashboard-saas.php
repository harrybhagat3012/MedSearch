	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content">
				...
				<h2 align="center" style="position: relative;top:120px;"> Welcome to Med Search </h2>
				<p style="position: relative;left: 650px;top:134px;" class="text-danger">( Admin Panel )</p>
			</div>
