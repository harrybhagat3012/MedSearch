                                                    ...
                                                    <div id="account-info">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="text" class="form-control" name="fname" id="fname" value="<?php echo $result->fname; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
                                                        ...
                                                        <div class="row form-group required">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <input type="email" class="form-control" id="email" placeholder="Email" value="<?php echo $result->email; ?>" name="email">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group required">
