<nav id="sidebar" class="sidebar">
         ...
         <!--  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <span class="align-middle me-3">MedSearch</span>
        </a>

				<ul class="sidebar-nav">
					<li class="sidebar-header">
						<h3 class="text-primary">Medical Store</h3>
					</li>
					...
					<li class="sidebar-item">
						<a href="inquries.php"  class="sidebar-link collapsed">
                           <i class="align-middle" data-feather="sliders"></i> <span class="align-middle"> Inquries</span>
                        </a>
						
					</li>
					<li class="sidebar-item">
						<a href="offer.php"  class="sidebar-link collapsed">
                           <i class="align-middle" data-feather="sliders"></i> <span class="align-middle"> Add Offers</span>
                        </a>
					</li>
