...
$id = $_SESSION["userid"];
$w =$obj->query("select * from showroom where shop_id='$id'");
										...
										<div class="card-body">
											...
											<form method="post">
												...
												<div class="mb-3">
													...
													<input type="password" class="form-control"  id="npassword" name="npassword" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" required> 
												</div>
												<div class="mb-3">
