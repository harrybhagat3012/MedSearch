...
$slot=$obj->query("select * from showroom_bookslot where status='pending'");
				...
				<div class="container-fluid p-0">
					...
					<div class="card flex-fill">
						...
						<table id="datatables-dashboard-products" class="table table-striped my-0">
							...
							<tbody>
								 <?php
                                         while($result = $slot->fetch_object())
                                         {
                                         	$ti=$obj->query("select * from time where t_id='$result->time'");
                                         	$time=$ti->fetch_object();

                                         	$cu=$obj->query("select * from customer where id='$result->customer_id'");
                                         	$cst=$cu->fetch_object();
                                           ?>
								<tr>
									<td><?php echo "$result->slot_id";?></td>
									<td><?php echo "$cst->fname $cst->lname";?></td>
									<td><?php echo "$cst->contact";?></td>
									
									<td><?php echo "$result->date";?></td>
									<td><?php echo "$time->time";?></td>
									<td><span class="badge bg-success"><?php echo "$result->status";?></span></td>
									<td><a href="updatestatus.php?slotid=<?php echo "$result->slot_id"?>">Update Status</a></td>
								</tr>
								<?php
                                         }
                               ?>
