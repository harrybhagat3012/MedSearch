...
if (isset($_POST['submit']))
 {
	...
	$e =$obj->query("select * from showroom where email='$email' and password='$password'");
...
<head>
	...
	<title>Sign In | Express Shopping</title>
					...
					<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
						<div class="d-table-cell align-middle">
							...
							<div class="text-center mt-4">
								<h1 class="h2">Welcome To MedSearch</h1>
								<p class="lead">
									...
									<div class="m-sm-4">
										...
										<form method="post">
											...
											<div class="mb-3">
			                                   ...
			                                   <input class="form-control form-control-lg" type="password" name="password" id="password" placeholder="Enter your password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" required />
												<small>
											...
											<div class="text-center mt-3">
												...
												<a href="signup.php" class="btn btn-primary btn-lg">Register</a>
